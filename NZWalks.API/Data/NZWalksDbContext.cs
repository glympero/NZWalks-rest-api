...
namespace NZWalks.API.Data
{
    public class NZWalksDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Difficulty {Id = Guid.Parse("b6bff9b0-954f-46d5-a616-e6855fa9d54b"), Name = "Easy"},
                new Difficulty {Id = Guid.Parse("2ec94da0-ebe1-47c3-bb68-2e53dbcbe7e1"), Name = "Medium"},
                new Difficulty {Id = Guid.Parse("be33977f-d323-4315-a0db-cd18842ba95b"), Name = "Hard"},
            };
